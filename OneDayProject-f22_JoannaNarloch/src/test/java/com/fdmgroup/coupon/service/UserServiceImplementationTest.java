...
class UserServiceImplementationTest {
    ...
    private UserServiceImplementation userServiceImplUnderTest;

    @BeforeEach
    void setUp() {
        userServiceImplUnderTest = new UserServiceImplementation(mockUserRepository, mockCouponRepository);
    }
    ...
    @Test
    void testRedeemCouponForUser() throws Exception, CouponHasBeenExceededException, TotalPriceTooLowException {
        // Setup
    ...
    void testRedeemCouponForUser_ThrowsCouponsExceeded() {
        ...
        // Run the test
        assertThatThrownBy(() -> userServiceImplUnderTest.redeemCouponForUser("username", "code")).isInstanceOf(CouponHasBeenExceededException.class);
    }
    ...
    void testRedeemCouponForUser_ThrowsTotalPriceToLowException() {
        ...
        // Run the test
        assertThatThrownBy(() -> userServiceImplUnderTest.redeemCouponForUser("username", "code")).isInstanceOf(TotalPriceTooLowException.class);
    }
}
