...
class UserCouponsControllerTest {
    ...
    void testSearchDetails() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/search-details").param("username", "username").accept(MediaType.TEXT_HTML)).andReturn().getResponse();;
    ...
    @Test
    void testRedeemCoupon2() throws Exception, CouponHasBeenExceededException, TotalPriceTooLowException {
        // Setup
        ...
        final MockHttpServletResponse response = mockMvc
            .perform(post("/redeem-coupon").param("username", "username").param("code", "code").accept(MediaType.TEXT_HTML))
            .andReturn()
            .getResponse();
    ...
    @Test
    void testRedeemCoupon2_IUserServiceThrowsTotalPriceToLowException() throws Exception, CouponHasBeenExceededException, TotalPriceTooLowException {
        // Setup
        when(mockUserService.redeemCouponForUser("username", "code")).thenThrow(TotalPriceTooLowException.class);
